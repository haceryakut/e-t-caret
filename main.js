...
//data değişkenini global scope'dan tanımladık
//bu sayde bütün fonksiyonlar bu değere erişebilecek
let data;
//ürünler verisini çeken gonksiyon
      ...
      (item) => `
         <div class="item">
            ...
            <img onclick="handleDelete(${
              item.id
            })" id="delete-img" src="/img/e-trash.png" />
          </div>
  `
    )
    .join(' ');
...
// reduce >diziyi döner ve elemanları belirlediğimiz 
//değerlerini toplar
...
totalInfo.innerHTML =  ` 
<span id="count"></span>${amount}</span>
         toplam: 
